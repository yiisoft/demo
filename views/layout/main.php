                ...
                ->items(
                    [
                        [
                            ...
                            'items' => [
                                [
                                    'label' => $translator->translate('layout.language.arabic'),
                                    'url' => $urlGenerator->generateFromCurrent(['_language' => 'ar'], 'site/index'),
                                ],
                                [
                                ...
                                [
                                    'label' => $translator->translate('layout.language.dutch'),
                                    'url' => $urlGenerator->generateFromCurrent(['_language' => 'nl'], 'site/index'),
                                ],
                                [
                                    'label' => $translator->translate('layout.language.chinese.simplified'),
                                    'url' => $urlGenerator->generateFromCurrent(['_language' => 'zh'], 'site/index'),
                                ],                                
                                [
                                    'label' => $translator->translate('layout.language.japanese'),
