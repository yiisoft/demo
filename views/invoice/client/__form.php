...
<input type="hidden" name="_csrf" value="<?= $csrf ?>">
  <div class="row">
    ...
    <div class="mb-3 form-group">
        <label for="client_name" class="form-label"><?= $s->trans('client_name'); ?></label>
  ...
  <div class="row">
    ...
    <div class="mb-3 form-group">
        <label for="client_email" class="form-label"><?= $s->trans('email'); ?></label>
