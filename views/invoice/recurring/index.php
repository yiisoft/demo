...
/**
 * @var \App\Invoice\Entity\Recurring $recurring
...
<?php
    if ($canEdit) {
        echo Html::a('Add',
        $urlGenerator->generate('recurring/add'),
    ...
    foreach ($recurrings as $recurring){
      ...
      echo Html::a('Edit',
      $urlGenerator->generate('recurring/edit', ['id' => $recurring->id]),
            ['class' => 'btn btn-info btn-sm ms-2']
          );
      echo Html::a('View',
      $urlGenerator->generate('recurring/view', ['id' => $recurring->id]),
      ['class' => 'btn btn-warning btn-sm ms-2']
             );
      //modal delete button
      echo Modal::widget()
      ->title('Please confirm that you want to delete this record# '.$recurring->id)
      ...
      ->footer(
                  ...
                  [
                   ...
                   $urlGenerator->generate('recurring/delete', ['id' => $recurring->id]),
