...
/**
 * @var \App\Invoice\Entity\Amount $amount
...
<?php
    if ($canEdit) {
        echo Html::a('Add',
        $urlGenerator->generate('amount/add'),
    ...
    foreach ($amounts as $amount){
      ...
      echo Html::a('Edit',
      $urlGenerator->generate('amount/edit', ['id' => $amount->id]),
            ['class' => 'btn btn-info btn-sm ms-2']
          );
      echo Html::a('View',
      $urlGenerator->generate('amount/view', ['id' => $amount->id]),
      ...
      ->footer(
                  ...
                  [
                   ...
                   $urlGenerator->generate('amount/delete', ['id' => $amount->id]),
