...
<?php       
            ...
            echo '              <li>'."\n";
            echo '                  <a href="<?= $urlGenerator->generate('."'".$generator->getSmall_singular_name()."/edit'".',['."'".$generator->getSmall_singular_name().'_id'."'".'=>$'.$generator->getSmall_singular_name().'->id]); ?>">';
            echo '                       <i class="fa fa-edit fa-margin"></i>'."\n";
            echo '                       <?= $s->trans('."'edit'".'); ?>'."\n";
            echo '                  </a>'."\n";
            echo '              </li>'."\n";
            echo '              <li>'."\n";
            echo '                  <form action="<?= $urlGenerator->generate('."'".$generator->getSmall_singular_name().'/delete'."'".',['."'".$generator->getSmall_singular_name().'_id'."'".'=>$'.$generator->getSmall_singular_name().'->id]); ?>"  method="POST">'."\n";
            echo '                      <?php $csrf; ?>'."\n";
            echo '                      <button type="submit" class="dropdown-button" onclick="return confirm('."'".'<?= $s->trans('."'delete_record_warning'".");?>');".'">'."\n";
