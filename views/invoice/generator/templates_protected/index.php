...
<?php   
        ...
        echo '      echo Html::br();'."\n";
        echo '      $label = $'.$generator->getSmall_singular_name().'->id . " "'.';'."\n";
        echo '      echo Html::label($label);'."\n";
        echo "      echo Html::a('Edit',"."\n";
        echo '      $urlGenerator->generate('."'".$generator->getSmall_singular_name().'/edit'."', ["."'id'".' => $'.$generator->getSmall_singular_name().'->id]),'."\n";
        echo "            ['class' => 'btn btn-info btn-sm ms-2']"."\n";
        echo '          );'."\n";                
        echo "      echo Html::a('View',"."\n";
        echo '      $urlGenerator->generate('."'".$generator->getSmall_singular_name().'/view'."', ["."'id'".' => $'.$generator->getSmall_singular_name().'->id]),'."\n";
        ...
        echo '                   $urlGenerator->generate('."'".$generator->getSmall_singular_name().'/delete'."', ["."'id'".' => $'.$generator->getSmall_singular_name().'->id]),'."\n";
