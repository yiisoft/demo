...
<?php
    ...
    foreach ($invtaxrates as $invtaxrate){
      ...
      echo Html::a('Edit',
      $urlGenerator->generate('invtaxrate/edit', ['id' => $invtaxrate->id]),
            ['class' => 'btn btn-info btn-sm ms-2']
          );
      echo Html::a('View',
      $urlGenerator->generate('invtaxrate/view', ['id' => $invtaxrate->id]),
      ['class' => 'btn btn-warning btn-sm ms-2']
             );
      //modal delete button
      echo Modal::widget()
      ->title('Please confirm that you want to delete this record# '.$invtaxrate->id)
      ...
      ->footer(
                  ...
                  [
                   ...
                   $urlGenerator->generate('invtaxrate/delete', ['id' => $invtaxrate->id]),
