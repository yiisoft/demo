<div class="panel panel-default no-margin">
    ...
    <div class="panel-body clearfix">
        ...
        <button type="button" class="btn btn-default fileinput-button">
            <i class="fa fa-plus"></i> <?= $s->trans('add_files'); ?>
        </button>
        <!-- dropzone -->
        <div class="row">
                ...
                <div id="previews" class="table table-condensed files no-margin">
                    <div id="template" class="file-row">
                        ...
                        <div class="pull-left btn-group">
                            <button data-dz-download class="btn btn-sm btn-info">
                                <i class="fa fa-download"></i>
                                <span><?= $s->trans('download'); ?></span>
                            </button>
                            <button data-dz-remove class="btn btn-sm btn-info">
                                <i class="fa fa-trash text-danger"></i>
                                <span><?= $s->trans('delete'); ?></span>
                            </button>
                        </div>
                    </div>
                </div>
