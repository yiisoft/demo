        ...
        <table id="item_table" class="items table-primary table table-bordered no-margin">
            ...
            <?php
                ...
                <tr>
                    ...
                    <td class="td-text">
                        <div class="input-group">
                            <input type="text" disabled="true" maxlength="4" size="4" name="inv_id" value="<?= $item->getInv_id(); ?>" data-toggle="tooltip" title="inv_item->inv_id">
                            <input type="text" disabled="true" maxlength="4" size="4" name="item_id" value="<?= $item->getId(); ?>" data-toggle="tooltip" title="inv_item->getId()">
                            <input type="text" disabled="true" maxlength="4" size="4" name="item_product_id" value="<?= $item->getProduct_id(); ?>" data-toggle="tooltip" title="inv_item->product_id">
                        </div>    
                        <div class="input-group">
                            <span class="input-group-text"><?= $s->trans('item'); ?></span>
                    ...
                    <td class="td-icon text-right td-vert-middle">
                        ...
                        <a href="<?= $urlGenerator->generate('invitem/edit',['id'=>$item->getId()]) ?>" class="btn btn-md btn-link"><i class="fa fa-pencil"></i></a>
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-md-6 col-md-offset-2 col-lg-4 col-lg-offset-4">
            <table class="table table-bordered text-right">
                ...
                <tr>
                    <td><a href="#add-inv-tax" data-toggle="modal" class="btn-xs"><i class="fa fa-plus-circle"></i></a><?= $s->trans('invoice_tax'); ?></td>
                    <td>
