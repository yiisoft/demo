...
/**
 * @var \App\Invoice\Entity\Invcust $invcust
...
<?php
    if ($canEdit) {
        echo Html::a('Add',
        $urlGenerator->generate('invcust/add'),
            ['class' => 'btn btn-outline-secondary btn-md-12 mb-3']
     );
    //list all the items
    foreach ($invcusts as $invcust){
      echo Html::br();
      $label = $invcust->id . " ";
      echo Html::label($label);
      echo Html::a('Edit',
      $urlGenerator->generate('invcust/edit', ['id' => $invcust->id]),
            ['class' => 'btn btn-info btn-sm ms-2']
          );
      echo Html::a('View',
      $urlGenerator->generate('invcust/view', ['id' => $invcust->id]),
      ...
      ->footer(
                  ...
                  [
                   ...
                   $urlGenerator->generate('invcust/delete', ['id' => $invcust->id]),
