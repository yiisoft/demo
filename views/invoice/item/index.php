...
/**
 * @var \App\Invoice\Entity\Item $item
...
<?php
    if ($canEdit) {
        echo Html::a('Add',
        $urlGenerator->generate('item/add'),
    ...
    foreach ($items as $item){
      ...
      echo Html::a('Edit',
      $urlGenerator->generate('item/edit', ['id' => $item->id]),
            ['class' => 'btn btn-info btn-sm ms-2']
          );
      echo Html::a('View',
      $urlGenerator->generate('item/view', ['id' => $item->id]),
      ...
      ->footer(
                  ...
                  [
                   ...
                   $urlGenerator->generate('item/delete', ['id' => $item->id]),
