...
<?php
    if ($canEdit) {
        echo Html::a('Add',
        $urlGenerator->generate('quote/add'),
    ...
    foreach ($quotes as $quote){
      ...
      echo Html::a('Edit',
      $urlGenerator->generate('quote/edit', ['id' => $quote->id]),
            ['class' => 'btn btn-info btn-sm ms-2']
          );
      echo Html::a('View',
      $urlGenerator->generate('quote/view', ['id' => $quote->id]),
      ['class' => 'btn btn-warning btn-sm ms-2']
             );
      //modal delete button
      echo Modal::widget()
      ->title('Please confirm that you want to delete this record# '.$quote->id)
      ...
      ->footer(
                  ...
                  [
                   ...
                   $urlGenerator->generate('quote/delete', ['id' => $quote->id]),
