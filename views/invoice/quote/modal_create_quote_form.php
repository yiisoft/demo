...
<form id="QuoteModalForm" method="POST" action="<?= $urlGenerator->generate(...$action) ?>" enctype="multipart/form-data">
...
<div id="headerbar">
    ...
    <div class="row">
        <div "col-xs-12 col-sm-6 col-md-5">
                ...
                <select name="client_id" id="create_quote_client_id" class="form-control simple-select" data-minimum-results-for-search="Infinity">
