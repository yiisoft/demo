...
<div class="mb3 form-group">
  <label for="date_added" class="form-label" style="background:lightblue"><?= $s->trans('date_added'); ?>  </label>
<?php $date = $body['date_added']; if ($date && $date != "0000-00-00") {    $datehelper = new DateHelper();  $date = $datehelper->date_from_mysql($date, false, $s);} else {  $date = null;}?><?= Html::encode($date); ?></div>
 <div class="mb3 form-group">
...
<label for="price" class="form-label" style="background:lightblue"><?= $s->trans('price'); ?></label>
 ...
 <div class="mb3 form-group">
<label for="discount_amount" class="form-label" style="background:lightblue"><?= $s->trans('discount_amount'); ?></label>
