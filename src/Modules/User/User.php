...
#[Entity(repository: \App\Modules\User\UserRepository::class)]
...
class User
{
     ...
     */
    #[HasMany(target: \App\Modules\Blog\Entity\Post::class)]
    private ArrayCollection $posts;

    /**
     * @var ArrayCollection<array-key, Comment>
     */
    #[HasMany(target: \App\Modules\Blog\Entity\Comment::class)]
