    ...
    public function __invoke(ContainerInterface $container)
    {
        $routes = [
            ...
            Group::create('/blog', [
                ...
                ])->addMiddleware(new SetFormat('application/json')),
            ]),
        ];
