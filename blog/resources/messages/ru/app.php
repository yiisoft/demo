...
return [
    ...
    'home.caption.slide1' => 'Всем привет!',
    'home.caption.placeholder1' => 'Отличный день чтобы попробовать Yii 3!',
    'home.caption.slide2' => 'Код ждёт!',
    'home.caption.placeholder2' => 'Изучите код проекта. Он не идеален потому как это ещё и песочница разработчиков, но даёт представление о том, что может Yii 3.',
    'home.caption.slide3' => 'Нам нужна обратная связь!',
    'home.caption.placeholder3' => 'Оствляйте её в Telegram или Slack, которые можно найти в README.',
